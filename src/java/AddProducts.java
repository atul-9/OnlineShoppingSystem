...
public class AddProducts extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String up_dir = "E:\\OnlineShoppingSystem\\web\\uploads";
        ...
        if (ServletFileUpload.isMultipartContent(request)) {
            ...
            try {
                ...
                multiparts= new ServletFileUpload(new DiskFileItemFactory()).parseRequest(new ServletRequestContext(request));
               // multiparts =  new ServletFileUpload(new DiskFileItemFactory()).parseRequest((RequestContext) request);
                ...
                for (FileItem item : multiparts) {
                    if (!item.isFormField()) {
                        ...
                        item.write(new File(up_dir + File.separator + imageName));
                ...
                try {
                    int id = 0;
                    String imagePath = up_dir + imageName;
