...
<body>
                ...
                <div class="top_nav_right">
                    <div class="cart box_1">
                        ...
                        <%
                            ...
                            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/shoppingsystem","root","xyz");
                            Statement st =con.createStatement();
                            ResultSet resultCount = st.executeQuery("select count(*) from tblcart where customer_id='" + session.getAttribute("id") + "'");
                            resultCount.next();
    ...
    <div class="product-easy">
        <div class="container">
            <div class="container">
                <h2>
                    <span><center>Our Best Products</center></span>
                </h2>
            </div>
            <%
                        ...
                        <div class="men-pro-item simpleCart_shelfItem">
                            ...
                            <div class="item-info-product ">
                                ...
                                <h5>
                                    ...
                                    <br><br><br>Description: <%=retriveProduct.getString("description")%>
